...
public class QueryWeekDto {
    ...
    public QueryWeekDto(Double alcohol, String date, String style) {
    ...
    public static List<QueryWeekDto> getWeekList(List<Map<LocalDate, Double>> week) {
        ...
        for(Map<LocalDate, Double> m : week){
            ...
            if(alcohol == null || alcohol.equals(0.0)){
                alcoholList.add(new QueryWeekDto(alcohol, index.format(formatter), "style4"));
            }
            else if(alcohol >= 30.0){
                alcoholList.add(new QueryWeekDto(alcohol, index.format(formatter), "style1"));
            }
            else {
                alcoholList.add(new QueryWeekDto(alcohol, index.format(formatter), "style2"));
            }
            index.plusDays(1);
        }
